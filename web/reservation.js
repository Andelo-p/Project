...
/*---People on table */
function costPerPeople(){
    let totalPrice;
    let num = document.getElementById("selectionofpeople").value;
    totalPriceOfPeople = num * 30;
    document.getElementById("selectionpeopleprice").value= totalPriceOfPeople + " kn"
}
